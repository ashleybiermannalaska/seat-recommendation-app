 ...
 */
export function rankSeats(seats, historicalFeedback, userId) {
    return seats.sort((a, b) => countPositiveFeedback(b, historicalFeedback, userId) - countPositiveFeedback(a, historicalFeedback, userId));
}
/**
...
*/
export function countPositiveFeedback(seat, historicalFeedback, userId) {
...
*/
export function getPreviousFeedback(seatId, userId, historicalFeedback) {
