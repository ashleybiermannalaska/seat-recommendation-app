 ...
 */
function rankSeats(seats, historicalFeedback, userId) {
 ...
 */
function getPreviousFeedback(seatId, userId, historicalFeedback) {
 ...
 */
function getSimilarSeats(seat, recommendedSeats) {
